...
"dbus-send --print-reply --dest=org.mpris.MediaPlayer2.lollypop /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause"
"mpc toggle"
)
...
"dbus-send --print-reply --dest=org.mpris.MediaPlayer2.lollypop /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Stop"
"mpc stop"
)
...
"dbus-send --print-reply --dest=org.mpris.MediaPlayer2.lollypop /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next"
"mpc next"
)
...
"dbus-send --print-reply --dest=org.mpris.MediaPlayer2.lollypop/org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous"
"mpc prev"
)
